...
const TOOLBAR = [
  ...
  { icon: 'A+', cmd: null, size: '5', title: 'Larger' },
  { icon: 'A−', cmd: null, size: '2', title: 'Smaller' },
  { icon: '—',  cmd: 'insertHorizontalRule', title: 'Divider' },
]

function RichTextEditor({ value, onChange, minHeight = 72 }) {
